...
public class BitWidthMismatchException extends IllegalArgumentException {

	public BitWidthMismatchException() {
		super("Bit widths do not match");
	}



	public BitWidthMismatchException(final String message) {
		super("Bit widths do not match: " + message);
	}
}
